                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Saxz Seu Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Window = Fluent:CreateWindow({
    Title = " Saxz Seu Hub | Blox Fruits",
    SubTitle = "Version 2",
    TabWidth = 160,
...
setclipboard("Saxz Seu Hub Is The Best")
...
Tabs.Main:AddButton({
        Title = "Saxz Seu Hub Discord Server",
...
Fluent:Notify({
    Title = "Saxz Seu Hub",
    Content = "Thanks For Using Saxz Seu Hub",
    Duration = 8
})
